...
public class Tache implements Comparable<Tache>, Comparator<Tache> {
	...
	public void setDebut(String date) {
		...
		debut.set(GregorianCalendar.MONTH,Integer.parseInt(date.substring(5, 7)) - 1);
	...
	public void setFin(String date) {
		...
		fin.set(GregorianCalendar.MONTH,Integer.parseInt(date.substring(5, 7)) - 1);
	...
	public String toString() {
		return "Tache [nom=" + nom + ", debut=" + debut.getTime() + ", fin=" + fin.getTime() + ", duree=" + duree + ", cout=" + cout
