...
Le fichier:			TestTache.java

Projet:				Laboratoire7_Tache

Objectifs:			Tester les tâches
	...
	public static void main(String[] args) {
		...
		{	
			...
			case '2':
				...
				tacheTemp = new Tache();
				tacheTemp.setNom(JOptionPane.showInputDialog("Entrez le nouveau nom de la tâche"));
				tacheTemp.setDebut(JOptionPane.showInputDialog("Entrez la nouvelle année de début de la tâche", "1900-01-01"));
				tacheTemp.setFin(JOptionPane.showInputDialog("Entrez la nouvelle année de début de la tâche", "1900-01-01"));
				tacheTemp.setDuree(Integer.parseInt(JOptionPane.showInputDialog("Entrez la nouvelle durée en heure de la tâche")));
				tacheTemp.setCout(Double.parseDouble(JOptionPane.showInputDialog("Entrez le nouveau coût de la tâche")));
