...
//		Les 2 factures sont différente.
		...
		if(Etudiant.getPondLabo() == Etudiant.getPondmanquante())
			...
			System.out.println("La pondération pour les laboratoires est de " + Etudiant.getPondLabo());
		...
		if(Etudiant.getPondMiSession() == Etudiant.getPondmanquante())
			...
			System.out.println("La pondération pour l'examen de mi-session est de " + Etudiant.getPondMiSession());
		...
		if(Etudiant.getPondSynthese() == Etudiant.getPondmanquante())
			...
			System.out.println("La pondération pour l'examen synthèse est de " + Etudiant.getPondSynthese());
		
		simon.définirAbandon();
		...
		if(nicolas.getNoteSynthese() == Etudiant.getNotemanquante())
			...
			System.out.println("La note pour l'examen synthèse est de " + nicolas.getNoteSynthese() + "%");
