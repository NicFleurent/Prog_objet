...
public class Facture {
	...
	public Facture(String nomClient, String nomItem, double prixItem, int qteItem, ClDate dateFacture) {
		numFacture = ++nbrTotalFacture;
	...
	public void setPrixItem(double _prixItem) {
		if(_prixItem >= 0)
	...
	public void setQteItem(int _qteItem) {
		if(_qteItem >= 0)
	...
	public boolean equals(Facture obj) {
		return (numFacture == obj.getNumFacture()
				...
				&&
				nomItem == obj.getNomItem()
				&&
				prixItem == obj.getPrixItem()
				&&
				qteItem == obj.getQteItem()
				&&
				dateFacture == obj.getDateFacture());
	}
